...
import { changePanel, accountSelect, database, Slider, config, popup, appdata, setBackground } from '../utils.js'
...
class Settings {
    ...
    async javaPath() {
        ...
        let configClient = await this.db.readData('configClient')
        let javaPath = configClient?.java_config?.java_path || 'Utilice la versión del libro java con el lanzador';
        ...
        document.querySelector(".java-path-reset").addEventListener("click", async () => {
            let configClient = await this.db.readData('configClient')
            javaPathInputTxt.value = 'Utilice la versión del libro java con el lanzador';
